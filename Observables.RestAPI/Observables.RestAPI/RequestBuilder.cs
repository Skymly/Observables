...
namespace Observables.RestAPI
{
    ...
    /// <summary>
    /// Provides static methods for creating request builders for declarative REST API interface types. This class enables the
    ...
    public static class RequestBuilder
    {
        ...
        /// interface.</typeparam>
        /// <param name="settings">The REST API settings to use for configuring the request builder. May be null to use default settings.</param>
        /// <returns>An instance of <see cref="IRequestBuilder{T}"/> that can be used to construct HTTP requests for the specified interface
        /// type.</returns>
#if NET8_0_OR_GREATER
...
#else
        public static IRequestBuilder<T> ForType<T>(RestApiSettings? settings) =>
            PlatformRequestBuilderFactory.Create<T>(settings);
#endif
        ...
        /// <summary>
        /// Creates an implementation of the specified REST API interface for making HTTP requests.
        /// </summary>
        /// <remarks>The returned <see cref="IRequestBuilder"/> uses reflection to analyze the provided interface type.
        ...
        /// <param name="refitInterfaceType">The interface type that defines the HTTP API contract. Must be a non-generic interface decorated with REST API
        /// attributes.</param>
        ...
        /// <summary>
        /// Creates an instance of an <see cref="IRequestBuilder"/> for the specified REST API interface type.
        /// </summary>
        /// <remarks>The specified interface type must be decorated with REST API attributes to define the
        ...
        /// <param name="refitInterfaceType">The interface type that defines the REST API contract. Must be a non-generic interface decorated with REST API
        /// attributes.</param>
        /// <returns>An <see cref="IRequestBuilder"/> instance that can be used to construct HTTP requests for the specified interface type.</returns>
#if NET8_0_OR_GREATER
        [RequiresUnreferencedCode("Refit uses reflection to analyze interface methods. Ensure referenced interfaces and DTOs are preserved when trimming.")]
#endif
