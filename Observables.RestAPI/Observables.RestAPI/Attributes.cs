...
#pragma warning disable CA1813 // Avoid unsealed attributes
    ...
    {
        /// <summary>
        /// Encodes everything using the ContentSerializer in RestApiSettings except for strings. Strings are set as-is
        /// </summary>
        Default,
        ...
        /// <summary>
        /// Encodes everything using the ContentSerializer in RestApiSettings
        /// </summary>
        Serialized
    }
    ...
    /// - For all other types, the object will be serialized using the content serializer specified in the request's <see cref="RestApiSettings"/>.
    /// </remarks>
