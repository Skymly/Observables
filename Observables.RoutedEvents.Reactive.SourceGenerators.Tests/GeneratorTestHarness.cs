...
using Observables.RoutedEvents.Reactive.SourceGenerators;

namespace Observables.RoutedEvents.Reactive.SourceGenerators.Tests;
...
internal static class GeneratorTestHarness
{
    internal static string BuildHarnessDocument(string userSource)
    {
        return $$"""
            #nullable enable
            using System;
            using Observables.RoutedEvents.Reactive;
        ...
        bool useWpf = false)
    {
        ...
        ImmutableArray<AdditionalText> additionalTexts = useWpf
