...
internal static class GeneratorTestHarness
{
    ...
    internal static GeneratorRunOutput Run(string userSource)
    {
        ...
        GeneratorDriver driver = CSharpGeneratorDriver.Create(
            generators: [new SseInterfaceStubGenerator().AsSourceGenerator()],
    ...
    internal static string ToSnapshot(GeneratorRunOutput output)
    {
        ...
        var diagnostics = output.Diagnostics
            .Where(static d => d.Id.StartsWith("OBS8", StringComparison.Ordinal))
    ...
    static MetadataReference[] GetMetadataReferences()
    {
        ...
        AddReference(platform, typeof(global::Observables.Sse.SseService).Assembly.Location);
        AddReference(platform, typeof(global::Observables.Sse.Reactive.SystemReactiveSseAdapter).Assembly.Location);
    ...
    CSharpParseOptions ParseOptions)
{
    ...
    /// <summary>
    /// Adds an unrelated (non-Sse) syntax tree to the compilation for cache testing.
    /// </summary>
