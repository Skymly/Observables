        ...
        )
        {
            ...
            if (bodyParamEnumerable == EnumerablePeek.Single)
            {
                return Tuple.Create(
                    ...
                    bodyParam.BodyAttribute.Buffered ?? RestApiSettings.Buffered,
        ...
        void DetermineReturnTypeInfo(MethodInfo methodInfo)
        {
            ...
            if (
                ...
                && (
                    ...
                    || methodInfo.ReturnType.GetGenericTypeDefinition() == typeof(global::R3.Observable<>)
            ...
            else
            {
                ...
                {
                    throw new ArgumentException(
                        $"Method \"{methodInfo.Name}\" is invalid. REST methods must return Task<T>, ValueTask<T>, R3 Observable<T>, or IObservable<T> (requires Observables.RestAPI.Reactive)."
                    );
                }
