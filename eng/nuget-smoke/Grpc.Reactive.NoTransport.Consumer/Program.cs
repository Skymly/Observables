...
public static class Program
{
    public static void Main()
    {
        ...
        if (hub is null)
        {
            throw new InvalidOperationException("Grpc Reactive no-transport generated proxy was not created.");
        }

        Console.WriteLine("Observables.Grpc.Reactive no-transport consumer smoke OK");
    }
}
