    ...
    CSharpParseOptions ParseOptions)
{
    ...
    /// <summary>
    /// Adds an unrelated (non-Grpc) syntax tree to the compilation for cache testing.
    /// </summary>
    ...
    {
        var tree = CSharpSyntaxTree.ParseText(BuildHarnessDocument(userSource), ParseOptions);
        return Compilation.AddSyntaxTrees(tree);
    }

    static string BuildHarnessDocument(string userSource) =>
        $$"""
        #nullable enable
        using System;
        using System.Threading;
