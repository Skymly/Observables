...
internal static class GeneratorTestHarness
{
    ...
    internal static string ToSnapshot(GeneratorRunOutput output)
    {
        ...
        foreach (var diagnostic in output.Diagnostics.Where(static d => d.Id.StartsWith("OBS5", StringComparison.Ordinal)).OrderBy(static d => d.Id))
        {
    ...
    static MetadataReference[] GetMetadataReferences()
    {
        ...
        AddReference(platform, typeof(global::Observables.Mqtt.Reactive.SystemReactiveMqttAdapter).Assembly.Location);
    ...
    CSharpParseOptions ParseOptions)
{
    ...
    /// <summary>
    /// Adds an unrelated (non-Mqtt) syntax tree to the compilation for cache testing.
    /// </summary>
