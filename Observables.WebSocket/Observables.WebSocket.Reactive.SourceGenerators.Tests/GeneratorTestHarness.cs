...
internal static class GeneratorTestHarness
{
    ...
    internal static GeneratorRunOutput Run(string userSource)
    {
        ...
        GeneratorDriver driver = CSharpGeneratorDriver.Create(
            generators: [new WebSocketInterfaceStubGenerator().AsSourceGenerator()],
    ...
    internal static string ToSnapshot(GeneratorRunOutput output)
    {
        ...
        var diagnostics = output.Diagnostics
            .Where(static d => d.Id.StartsWith("OBS6", StringComparison.Ordinal))
    ...
    static MetadataReference[] GetMetadataReferences()
    {
        ...
        AddReference(platform, typeof(global::Observables.WebSocket.WebSocketService).Assembly.Location);
        AddReference(platform, typeof(global::Observables.WebSocket.Reactive.SystemReactiveWebSocketAdapter).Assembly.Location);
    ...
    CSharpParseOptions ParseOptions)
{
    ...
    /// <summary>
    /// Adds an unrelated (non-WebSocket) syntax tree to the compilation for cache testing.
    /// </summary>
