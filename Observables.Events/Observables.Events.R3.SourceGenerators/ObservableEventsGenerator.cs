...
public sealed partial class ObservableEventsGenerator : IIncrementalGenerator
{
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        ...
        {
            ctx.AddSource(
                "Observables.Events.R3.ObservableEventsBootstrapExtensions.g.cs",
                SourceText.From(
                    ...
                    Encoding.UTF8));
            ctx.AddSource(
                "Observables.Events.R3.NullEvents.g.cs",
                SourceText.From(
        ...
        context.RegisterSourceOutput(pipeline, (spc, input) =>
        {
            ...
            {
                spc.AddSource(
                    "Observables.Events.R3.ObservableEventsBootstrapExtensions.Routed.g.cs",
                    SourceText.From(
                        GeneratedSourceHeader.ToSource(
